...
$string['checklist:viewcoursecalibrationreport'] = 'Voir le rapport de calibrage du cours';
$string['checklist:viewtutorboard'] = 'Voir le tableau de synthèse des temps tutoraux';
...
$string['coursecalibrationreport'] = 'Tableau de calibrage du cours';
...
$string['enablecredit'] = ' Activer le crédit ';
$string['estimated'] = 'Estimation';
...
$string['tutorboard'] = 'Temps de tutorat (cours)';
...
$string['checklist_autoupdate_use_cron'] = 'Mise à jour automatique par cron';
$string['configchecklistautoupdateusecron'] = 'Les accomplissements seront automatiquement marqués sur la base d\'événements des traces';
