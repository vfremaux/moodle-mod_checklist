...
$string['checklist:viewcoursecalibrationreport'] = 'View course calibration report';
$string['checklist:viewtutorboard'] = 'View the tutor time board';
...
$string['completionboard'] = 'Completion list';
...
$string['emailoncompletebody'] = 'User $a->user has completed checklist \'$a->checklist\' View the checklist here:';
...
$string['savechecksandeditoff'] = 'Save and quit edit mode';
...
$string['checklist_autoupdate_use_cron'] = 'Enable autoupdate by cron';
$string['configchecklistautoupdateusecron'] = 'Checks will be automatically detected using log events';
